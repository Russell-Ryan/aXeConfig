...
setup(name=PKG,
      ...
      long_description='Python API for working with grism configuration in aXe format written as HDF5',
      license='MIT',
      setup_requires=['wget','urllib','shutil'],
      install_requires=['h5py','astropy','numpy>1.16', 'polyclip @ git+https://github.com/russell-ryan/polyclip#egg=polyclip'],
